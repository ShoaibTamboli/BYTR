...
db.serialize(() => {
  ...
  const books = [
    ...
    { title: 'The Fellowship of the Ring', author: 'J.R.R. Tolkien', year: 1954, genre: 'Fantasy' },
    { title: 'War and Peace', author: 'Leo Tolstoy', year: 1869, genre: 'Historical Fiction' },
    { title: 'Crime and Punishment', author: 'Fyodor Dostoevsky', year: 1866, genre: 'Novel' },
    { title: 'The Brothers Karamazov', author: 'Fyodor Dostoevsky', year: 1880, genre: 'Novel' },
    { title: 'The Da Vinci Code', author: 'Dan Brown', year: 2003, genre: 'Mystery' },
    { title: 'Angels & Demons', author: 'Dan Brown', year: 2000, genre: 'Mystery' },
